...
struct FilterRepositoryTests {
    ...
    func when_saveActiveFilter_and_getActiveFilter_then_returnsSavedFilter() async throws {
        let repo = FilterRepository()
        let filter = Filter(age: 1...2, weight: 3...4, height: 5...6, hairColor: ["A"], profession: ["B"], friends: 7...8)
...
private extension FilterRepositoryTests {
    func makeCharacters() -> [Character] {
        return [
            Character(id: 1, name: "Alice", thumbnail: "", age: 20, weight: 50, height: 150, hairColor: "Blonde", professions: ["Farmer", "Miner"], friends: ["Bob"]),
            Character(id: 2, name: "Bob", thumbnail: "", age: 30, weight: 70, height: 170, hairColor: "Brown", professions: ["Builder"], friends: ["Alice", "Charlie"]),
            Character(id: 3, name: "Charlie", thumbnail: "", age: 25, weight: 60, height: 160, hairColor: "Red", professions: [], friends: [])
        ]
    }
}
